...
-(void)aboveView:(CGFloat)pixels  toView:(UIView*)toView
{
    NSAssert(self.translatesAutoresizingMaskIntoConstraints == NO, @"Please enable your view for autolayout using enableAutolayout");
    NSLayoutConstraint *contraint = [NSLayoutConstraint constraintWithItem:self attribute:NSLayoutAttributeBottom relatedBy:NSLayoutRelationEqual toItem:toView attribute:NSLayoutAttributeTop multiplier:1 constant:pixels];
...
-(void)equalHeightToView:(UIView *)secondView
{
    
    NSAssert(self.translatesAutoresizingMaskIntoConstraints == NO, @"Please enable your view for autolayout using enableAutolayout");
    NSLayoutConstraint *contraint = [NSLayoutConstraint constraintWithItem:self attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:secondView attribute:NSLayoutAttributeHeight multiplier:1 constant:0];
